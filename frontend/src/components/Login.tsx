...
function isAxiosError(error: unknown): error is { isAxiosError: boolean; response?: { data?: { detail?: string } } } {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (isAxiosError(error) && error.response) {
        setError((error.response.data as { detail?: string }).detail || 'An error occurred');
      } else {
